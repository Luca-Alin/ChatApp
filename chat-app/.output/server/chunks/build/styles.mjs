...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.CXrZOc6U.mjs').then(interopDefault),
  "plugins/vuetify.ts": () => import('./vuetify-styles.DdwCj96W.mjs').then(interopDefault),
