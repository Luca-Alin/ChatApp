import { version as version$1, unref, inject as inject$1, createVNode, mergeProps, defineComponent as defineComponent$1, useSSRContext, createApp, effectScope, reactive, warn, computed, shallowRef, watchEffect, getCurrentInstance as getCurrentInstance$1, hasInjectionContext, provide, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, resolveComponent, ref, watch, toRefs, h, onScopeDispose } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, n as sanitizeStatusCode, o as createHooks } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-C0ob1ml2.mjs').then((m) => m.default || m)
  }
];
